...
export function CostForm({
  ...
  const isPayableOrigin = Boolean(existingCost?.originType === "payable" && existingCost.originId);

  useEffect(() => {
    // A cost generated by a Payable is managed exclusively from Contas a
    // Pagar — redirect away instead of exposing the manual edit/delete
    // form for it, even when this route is opened directly by URL.
    if (existingCost?.originType === "payable" && existingCost.originId) {
  ...
  if (isPayableOrigin) return null;
