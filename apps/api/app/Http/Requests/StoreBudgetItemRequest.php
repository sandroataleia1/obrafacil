...
class StoreBudgetItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unit' => ['required_unless:source_type,catalog', 'prohibited_if:source_type,catalog', 'string', 'max:255'],
            ...
            'calculation_snapshot' => ['prohibited_unless:source_type,calculator', 'nullable', 'array'],
