...
/**
 * PUT /api/v1/suppliers/{supplier} — SUPPLY-API-01A §16-19/§21-23.
 * `id`/`company_id` can never change. No optimistic concurrency in this
 * gate — same precedent as Material/CatalogItem.
 */
