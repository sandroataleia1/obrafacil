...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Authored locally for this application, matching the key structure
    | published by `php artisan lang:publish` for this Laravel version.
    | Does not depend on network access at runtime.
    |
    */
    ...
    */
    ...
    'attributes' => [
        ...
        'execution_terms' => 'condições de execução',
